...
public abstract class BaseBO<T> {
	...
	public ResponseEntity<APIEndpointResponse> buildErrorResponse(APIRequest apiRequest,
			String detailMsg, String shortMsg) {
	...
	public ResponseEntity<APIEndpointResponse> buildIllegalArgumentException(final APIRequest apiRequest, final Set<String> allInvalidArgumentErrors) {
	...
	public ResponseEntity<APIEndpointResponse> buildInternalSystemErrorResponse(final APIRequest apiRequest, final String errorCode) {
	 ...
	 */
	protected ResponseEntity<APIEndpointResponse> generatValidationFailureErrorResponse(APIRequest apiRequest, ValidationResult validationResult) {
