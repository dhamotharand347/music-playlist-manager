...
public class CommonUtils {
	...
	public static String subtractDurations(String existingDuration, String newSongDuration) {
		// Split the existing and new durations into hours, minutes, and seconds
		String[] existingParts = existingDuration.split(":");
		String[] newSongParts = newSongDuration.split(":");
		...
		// Calculate the total hours, minutes, and seconds by subtracting the
		// newSongDuration
		int totalHours = existingHours;
		int totalMinutes = existingMinutes - newSongMinutes;
		int totalSeconds = existingSeconds - newSongSeconds;

		// Handle negative minutes or seconds
		if (totalSeconds < 0) {
			totalMinutes -= 1;
			totalSeconds += 60;
		}
		...
		// Handle the case where the duration is negative
		if (totalHours < 0) {
			return "Negative Duration"; // or handle as needed
		}
